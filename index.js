...
console.log(createMenuItem("pasta-marinara", 15, "dinner"));
console.log(createMenuItem("bagel & cheese", 6, "breakfast"));
console.log(createMenuItem("fish &chips", 10, "lunch"));
...
export const burger = {
  ...
  price: 18, 
  category: "Lunch", 
  discount: function discMethod (stringP) {
    if (stringP === "teacher" || stringP === "student") {
      return (this.price*.75)
    } else if (stringP === "public") {
...
*/
reviews[8] = {name: "Tim", rating: 4.75, feedback: "I like it like that"};
// console.log(reviews);
...
*/
 ...
 function getReviewByRating(array, rating) {
    if (array.rating.forEach >= 4 || array.rating.forEach < 5) {
